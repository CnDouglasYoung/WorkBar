<%@ Page Title="" Language="C#" MasterPageFile="~/master/mine.master" AutoEventWireup="true" CodeFile="guanzhu.aspx.cs" Inherits="母版页_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 .f:hover {color :white;background-color:#666;}
    ...
    <div runat="server" id="rwcd" style="border-color: #ECA027; margin-top: 15px; border-top-style: solid;" >
                     ...
                     <asp:LinkButton runat="server" CssClass="f" BackColor="#F29503" PostBackUrl="~/mine/guanzhu.aspx">我关注的</asp:LinkButton> 
                     <asp:LinkButton ID="LinkButton2" runat="server" CssClass="f" PostBackUrl="~/mine/fuze.aspx">我负责的</asp:LinkButton> 
    ...
    <asp:Panel ID="Panel1" runat="server" Height="400px" ScrollBars="Vertical">
         <div  style="padding:10px">
                <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource3" OnItemDataBound="DataList3_ItemDataBound" DataKeyField="BelongItem" OnItemCommand="DataList3_ItemCommand">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:默认 %>" SelectCommand="SELECT   Assignment.AssId, Assignment.Name, Assignment.Remark, Assignment.BeginTime, Assignment.EndTime, 
                Assignment.IsImportant, User_.Name AS Name1, Assignment.BelongItem, Item.Name AS ItemName
FROM      Assignment INNER JOIN
                Concern ON Assignment.AssId = Concern.AssId INNER JOIN
                User_ ON Assignment.ResponsibleUID = User_.UID INNER JOIN
                Item ON Assignment.BelongItem = Item.ItemId
WHERE   (Concern.UID = @UID)
