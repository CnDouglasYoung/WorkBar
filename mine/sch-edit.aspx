<%@ Page Title="" Language="C#" MasterPageFile="~/master/mine.master" AutoEventWireup="true" CodeFile="sch-edit.aspx.cs" Inherits="mine_sch_add" %>
...
<script type="text/javascript">
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="544px" ScrollBars="Vertical">
<table >
            <tr>
                <td>
        ...
        <tr><td>日程详情：<asp:TextBox ID="xq" runat="server" />
        <br /></td></tr>
    <tr>
        <td>
...
FROM     Assignment left JOIN
                Item ON Assignment.BelongItem = Item.ItemId left JOIN
                Ass_User ON Assignment.AssId = Ass_User.AssId
WHERE   (Ass_User.UID=@UID) or (Assignment.ResponsibleUID=@UID)or(Assignment.AssId=@AssId)">
            <SelectParameters>
        ...
        <tr><td>开始时间：
        <asp:TextBox id="st" runat="server"  onclick="SelectDate(this)" Width="190px" CssClass="unLinked" /><br />
        </td></tr><tr><td>结束时间：
