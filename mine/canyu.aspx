<%@ Page Title="" Language="C#" MasterPageFile="~/master/mine.master" AutoEventWireup="true" CodeFile="canyu.aspx.cs" Inherits="母版页_Default3" %>
...
#rwcd {background-color:#eee; width:760px; height:30px; margin:0 auto;}
 ...
 .f:hover {color :white;background-color:#666;}
    ...
    <div runat="server" id="rwcd" style="border-color: #ECA027; margin-top: 15px; border-top-style: solid;" >             
                     <asp:LinkButton ID="LinkButton1" runat="server" CssClass="f" PostBackUrl="~/mine/guanzhu.aspx">我关注的</asp:LinkButton> 
                     <asp:LinkButton ID="LinkButton2" runat="server" CssClass="f" PostBackUrl="~/mine/fuze.aspx">我负责的</asp:LinkButton>
                     <asp:LinkButton ID="LinkButton3" runat="server" CssClass="f" BackColor="#F29503" PostBackUrl="~/mine/canyu.aspx">我参与的</asp:LinkButton>
    </div>    <br /><br /><br />
    <asp:Panel ID="Panel1" runat="server" Height="400px" ScrollBars="Vertical">
     <div  style="padding:10px">
             <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource3" OnItemDataBound="DataList3_ItemDataBound" DataKeyField="BelongItem">
                                                    <ItemTemplate>
